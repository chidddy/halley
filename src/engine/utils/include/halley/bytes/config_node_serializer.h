...
namespace Halley
{
    ...
    {
    public:
        ConfigNode serialize( Vector3i value, const ConfigNodeSerializationContext& context )
        {
            return ConfigNode( value );
        }

        Vector3i deserialize( const ConfigNodeSerializationContext&, const ConfigNode& node )
        {
    ...
    {
    public:
        ConfigNode serialize( Vector3f value, const ConfigNodeSerializationContext& context )
        {
            return ConfigNode( value );
        }

        Vector3f deserialize( const ConfigNodeSerializationContext&, const ConfigNode& node )
        {
